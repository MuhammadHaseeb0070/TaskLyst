...
// Image Upload Area Component (handles both URI strings and require() images)
...
// Info Icon Component
const InfoIcon = () => (
  <View className="w-6 h-6 rounded-full border-2 border-[#3B82F6] items-center justify-center">
    <Text className="text-[#3B82F6] text-[14px] font-bold">i</Text>
  </View>
);
...
export default function EditServiceScreen() {
  ...
  useEffect(() => {
    if (serviceId) {
      ...
      if (service) {
        ...
        // Note: Service interface doesn't have category/subcategory
        // They will remain empty and user can set them
      }
    }
  }, [serviceId]);
  ...
  const handleNext = () => {
    ...
    // Navigate to step 2
    router.push({
      pathname: "/edit-service-step2",
      params: {
        serviceId, // Pass serviceId to indicate edit mode
        serviceName,
        category,
        categoryLabel,
        subcategory,
