...
import { View, Text, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, ScrollView, Image, Modal, FlatList } from 'react-native';
          ...
          <View className="mt-8">
            ...
            <View className="flex-row">
              ...
              <TouchableOpacity
                ...
                style={softShadow}
              >
                <Text className="text-[15px] mr-1">{selectedCountry.flag}</Text>
                <Text className="text-[#2C3E50] text-[15px]">{selectedCountry.code}</Text>
                <Text className="text-gray-400 text-[10px] ml-1">▼</Text>
              </TouchableOpacity>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity
                  ...
                  style={{
                    backgroundColor: selectedCountry.code === item.code ? '#F0FFFE' : 'white',
                  }}
                >
                  <Text className="text-[20px] mr-3">{item.flag}</Text>
                  <Text className="flex-1 text-[#2C3E50] text-[15px]">{item.country}</Text>
